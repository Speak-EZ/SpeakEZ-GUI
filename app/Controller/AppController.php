 ...
 public $components = array(
  'RequestHandler',
    ...
    $this->Auth->allow('login','initDB');
         $this->Auth->allow('login', 'refresh','logout', 'addRemoteBatch', 'record'); //addRemoteBatch is for SMS sending, called by Freeswitch Javascript; record is for in-browser recording
 ...
 */
function uploadFiles($folder, $data, $itemId = null, $filetype, $useKey, $overWrite, $outboundFile = false) {
